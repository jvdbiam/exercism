...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # apply spread (percentage) to the exchange rate to get the effective rate
    effective_rate = exchange_rate * (1 + spread / 100.0)
    # convert budget to foreign currency using the effective rate
    exchanged = budget / effective_rate
    # count whole bills of the given denomination
